        ...
        <div id="About">
            <div id="txt-pick">
                ...
                <div id = "text">
                    ...
                    <p>
                        Our platform “Helping Hands” provides humanitarian migrants in Germany with help &amp; support to ensure a smoother process of integration –to enable them to contribute to their new host countries - as workers, as taxpayers, and as consumers.
                    </p>
                </div>
            </div>
